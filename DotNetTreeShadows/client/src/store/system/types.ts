...
export type KnownSystemAction = UpdateSessionAction | SignInUserSuccess | SignInUserRequest | SignInUserFailure | RegisterNewUserFailure | RegisterNewUserRequest | RegisterNewUserSuccess;
