...
public static GetPieceType = (tileCode: number) =>
Tile.GetTileType( tileCode ) != TileType.Piece
    ? null
    : Tile.GetPieceTypeCode( tileCode );

public static GetTreeType= (tileCode: number) =>
Tile.GetTileType( tileCode ) != TileType.Piece
    ? null
    : Tile.GetTreeTypeCode( tileCode );

private static GetTileType= (tileCode: number):TileType => Tile.GetTileTypeCode( tileCode ) as TileType;
...
public static  SetTreeType (tileCode: number, treeType: TreeType|null) {
   ...
   public static TreeTypeIs= (tileCode: number, treeType: TreeType) : boolean => {return Tile.GetTreeType( tileCode ) == treeType;}
