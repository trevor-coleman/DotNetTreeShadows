...
namespace dotnet_tree_shadows.Models.SessionModels {
  public class Session {
    ...
    public Session (SessionDtoWithId dto) {
      {
        Id = dto.Id;
        Players = dto.Players.ToList();
        Game = new Game(dto.Game);
        Name = dto.Name;
        Invitations = dto.Invitations.ToList();
    ...
    public Session (Profile host) {
      Id = "";
      Players = new List<string>() { host.Id };
    ...
    public bool TryExecuteAction (ATurnAction aTurnAction, out string? failureReason) =>
      aTurnAction.Execute( out failureReason );
    ...
    public SessionDtoWithId DtoWithId () =>
      new SessionDtoWithId() {
        Id = Id,
        Host = Host,
        Players = Players.ToArray(),
        Game = Game.Dto(),
