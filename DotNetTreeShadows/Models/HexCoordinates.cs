...
namespace dotnet_tree_shadows.Models {
    public readonly struct HexCoordinates {
        ...
        public static HexCoordinates operator * (int n, HexCoordinates a) => new HexCoordinates(n*a.Q, n*a.R, n*a.S);
        ...
        public override int GetHashCode() => ShiftAndWrap(Q.GetHashCode(),4) ^ ShiftAndWrap( R.GetHashCode(),2 ) ^ S.GetHashCode();
